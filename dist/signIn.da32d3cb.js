...
},{"./..\\img\\bg.png":[["bg.3b919608.png",24],24],"_css_loader":23}],12:[function(require,module,exports) {
'use strict';
  ...
  methods: {
    onSignIn: function onSignIn() {
      ...
      AV.User.logIn(this.signInData.email, this.signInData.password).then(function (loggedInUser) {
        _this.$router.push({ name: '/', params: { message: 'signInSuccess', email: _this.signInData.email, password: _this.signInData.password } });
      }, function (error) {
        if (error.code === 211) {
          _this.showPrompt('✘', '邮箱不存在！');
        } else if (error.code == 210) {
          _this.showPrompt('✘', '密码错误！');
        }
      });
    },
    ...
    showPrompt: function showPrompt(icon, info) {
...
},{"../css/signIn.css":21}],26:[function(require,module,exports) {
